...
<section class="articles-section">
    <div class="container">
        ...
        <article class="article-detail">
            ...
            {{-- Edit Button (Admin OR Article Owner) --}}
            @auth
            ...
            <div class="comments-wrapper" style="margin-top: 4rem;">
                ...
                @auth
                    <div class="comment-form-wrapper" style="background: var(--bg-secondary); padding: 2rem; border-radius: 12px; margin-bottom: 3rem;">
                        ...
                        <form action="{{ route('articles.comments.store', $article) }}" method="POST" id="commentForm">
                            ...
                            <div style="margin-bottom: 1.5rem; padding: 1rem; background: var(--bg-primary); border-radius: 8px; display: flex; align-items: center; gap: 0.75rem;">
                                ...
                                <div>
                                    ...
                                    <span style="display: block; font-size: 0.875rem; color: var(--text-secondary);">Posting as</span>
                                </div>
                            </div>
                ...
                @else
                    ...
                    <div class="login-prompt" style="background: var(--bg-secondary); padding: 2rem; border-radius: 12px; margin-bottom: 3rem; text-align: center; border: 2px dashed var(--border-color);">
                        <i data-lucide="lock" style="width: 48px; height: 48px; margin: 0 auto 1rem; opacity: 0.5; color: var(--text-secondary);"></i>
                        <h4 style="font-size: 1.25rem; font-weight: 600; color: var(--text-primary); margin-bottom: 0.5rem;">
                            Login to Comment
                        </h4>
                        <p style="color: var(--text-secondary); margin-bottom: 1.5rem;">
                            Please login to leave a comment or reply to existing comments.
                        </p>
                        <a href="{{ route('login') }}" style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.875rem 2rem; background: linear-gradient(135deg, var(--primary-color), var(--secondary-color)); color: white; border-radius: 8px; text-decoration: none; font-weight: 600;">
                            ...
                            <div class="comment-item" style="background: var(--bg-secondary); padding: 1.5rem; border-radius: 12px; margin-bottom: 1.5rem;">
                                ...
                                <div style="display: flex; align-items: start; gap: 1rem; margin-bottom: 1rem;">
                                    ...
                                    <div style="flex: 1;">
                                        ...
                                        {{-- Reply Button (Logged in only) --}}
                                        @auth
                                            <button 
                                                onclick="toggleReplyForm({{ $comment->id }})"
                                                style="background: none; border: none; color: var(--primary-color); font-weight: 600; cursor: pointer; font-size: 0.875rem; padding: 0.5rem 0; display: inline-flex; align-items: center; gap: 0.5rem; transition: all 0.3s ease;"
                                            >
                                ...
                                @auth
                                    <div id="replyForm{{ $comment->id }}" style="display: none; margin-left: 4rem; margin-top: 1rem; padding: 1.5rem; background: var(--bg-primary); border-radius: 8px; border-left: 3px solid var(--primary-color);">
                                        <form action="{{ route('articles.comments.store', $article) }}" method="POST">
                                            ...
                                            {{-- Show who is replying --}}
                                            <div style="margin-bottom: 1rem; display: flex; align-items: center; gap: 0.5rem; padding: 0.75rem; background: var(--bg-secondary); border-radius: 6px;">
                                                <div style="width: 28px; height: 28px; border-radius: 50%; background: var(--primary-color); display: flex; align-items: center; justify-content: center; color: white; font-weight: 700; font-size: 0.75rem;">
                                                    {{ substr(auth()->user()->name, 0, 1) }}
                                                </div>
                                                    ...
                                                    <div style="flex: 1;">
                                                        <div style="display: flex; justify-content: space-between; align-items: start; margin-bottom: 0.5rem;">
                                                            <div>
                                                                ...
                                                                <span style="color: var(--text-secondary); font-size: 0.8rem; display: flex; align-items: center; gap: 0.25rem;">
