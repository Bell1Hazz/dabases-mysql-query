...
<section class="articles-section">
    <div class="container" style="max-width: 1000px;">
        <div class="page-header" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
            ...
            <a href="{{ route('author.articles.create') }}" style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.875rem 2rem; background: linear-gradient(135deg, var(--primary-color), var(--secondary-color)); color: white; border-radius: 8px; text-decoration: none; font-weight: 600;">
                        ...
                        <tr style="border-top: 1px solid var(--border-color);">
                            ...
                            <td style="padding: 1rem;">
                                <div style="display: flex; gap: 0.5rem;">
                                    <a href="{{ route('articles.show', $article) }}" style="width: 36px; height: 36px; display: flex; align-items: center; justify-content: center; background: var(--bg-secondary); border-radius: 8px; color: var(--text-primary); text-decoration: none;">
                                        <i data-lucide="eye" style="width: 18px; height: 18px;"></i>
                                    </a>
                                    <a href="{{ route('author.articles.edit', $article) }}" style="width: 36px; height: 36px; display: flex; align-items: center; justify-content: center; background: var(--bg-secondary); border-radius: 8px; color: var(--text-primary); text-decoration: none;">
                    ...
                    @empty
                        <tr>
                            <td colspan="5" style="padding: 3rem; text-align: center; color: var(--text-secondary);">
                                No articles yet. <a href="{{ route('author.articles.create') }}" style="color: var(--primary-color); font-weight: 600;">Create your first article!</a>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
